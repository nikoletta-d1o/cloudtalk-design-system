import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as a}from"./index-ZH-6pyQh.js";import{c as m}from"./utils-BQHNewu7.js";import{X as k}from"./x-CDsTmnuk.js";import{B as i}from"./button-D5pL3hg0.js";import"./_commonjsHelpers-CqkleIqs.js";import"./createLucideIcon-huI5jBd3.js";import"./index-D1SQP9Z-.js";function l({open:s,onClose:t,width:N="560px",header:j,children:b,footer:c,className:w}){const[S,d]=a.useState(!1),[p,u]=a.useState(!1);return a.useEffect(()=>{if(s)d(!0),requestAnimationFrame(()=>{requestAnimationFrame(()=>u(!0))});else{u(!1);const n=setTimeout(()=>d(!1),300);return()=>clearTimeout(n)}},[s]),a.useEffect(()=>{if(!s)return;const n=P=>{P.key==="Escape"&&t()};return document.addEventListener("keydown",n),()=>document.removeEventListener("keydown",n)},[s,t]),S?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:m("fixed inset-0 z-40 bg-black/50 transition-opacity duration-300",p?"opacity-100":"opacity-0"),onClick:t}),e.jsxs("div",{style:{width:N},className:m("fixed right-0 top-0 z-50 flex h-full max-w-[calc(100vw-84px)] flex-col bg-white shadow-xl transition-transform duration-300 ease-out",p?"translate-x-0":"translate-x-full",w),children:[e.jsxs("div",{className:"flex items-center justify-between border-b border-gray-cool-200 px-6 py-5",children:[e.jsx("div",{className:"flex items-center gap-3",children:j}),e.jsx("button",{onClick:t,className:"flex h-8 w-8 items-center justify-center rounded-full text-gray-cool-400 hover:bg-gray-cool-100 hover:text-gray-cool-600 transition-colors",children:e.jsx(k,{className:"h-5 w-5"})})]}),e.jsx("div",{className:"flex-1 overflow-y-auto",children:b}),c&&e.jsx("div",{className:"border-t border-gray-cool-200",children:c})]})]}):null}l.__docgenInfo={description:"",methods:[],displayName:"SidePanel",props:{open:{required:!0,tsType:{name:"boolean"},description:""},onClose:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},width:{required:!1,tsType:{name:"string"},description:'Panel width. Default "560px"',defaultValue:{value:'"560px"',computed:!1}},header:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Header content (rendered inside the header bar, alongside the close button)"},children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Main scrollable content"},footer:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Optional sticky footer (e.g. a chat input)"},className:{required:!1,tsType:{name:"string"},description:""}}};const D={title:"Components/SidePanel",component:l,tags:["autodocs"],parameters:{layout:"fullscreen"}},r={render:()=>{const[s,t]=a.useState(!1);return e.jsxs("div",{className:"p-6",children:[e.jsx(i,{onClick:()=>t(!0),children:"Open Panel"}),e.jsx(l,{open:s,onClose:()=>t(!1),header:e.jsx("h2",{className:"text-lg font-semibold text-gray-cool-900",children:"Panel Title"}),children:e.jsx("div",{className:"p-6",children:e.jsx("p",{className:"text-sm text-gray-cool-600",children:"Panel content goes here."})})})]})}},o={render:()=>{const[s,t]=a.useState(!1);return e.jsxs("div",{className:"p-6",children:[e.jsx(i,{onClick:()=>t(!0),children:"Open Panel with Footer"}),e.jsx(l,{open:s,onClose:()=>t(!1),header:e.jsx("h2",{className:"text-lg font-semibold text-gray-cool-900",children:"Details"}),footer:e.jsxs("div",{className:"flex justify-end gap-2 p-4",children:[e.jsx(i,{variant:"outline",onClick:()=>t(!1),children:"Cancel"}),e.jsx(i,{children:"Save"})]}),children:e.jsx("div",{className:"p-6",children:e.jsx("p",{className:"text-sm text-gray-cool-600",children:"This panel has a sticky footer with action buttons."})})})]})}};var f,x,h;r.parameters={...r.parameters,docs:{...(f=r.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => {
...
}`,...(v=(y=o.parameters)==null?void 0:y.docs)==null?void 0:v.source}}};const _=["Default","WithFooter"];export{r as Default,o as WithFooter,_ as __namedExportsOrder,D as default};
